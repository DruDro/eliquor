...
export class RecipeService {
  ...
  private recipesUrl = 'http://10.0.2.43:3001/recipes';  // URL to web api
  private topRecipesUrl = 'http://10.0.2.43:3001/recipes?_sort=rating&_order=desc&_start=0&_end=4';  // URL to web api
}
